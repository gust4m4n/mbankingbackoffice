...
import 'package:mbankingbackoffice/widget-x/media_x.dart';

import '../../widget-x/all_widgets.dart';
import 'mbx_news_controller.dart';

class MbxNewsScreen extends StatelessWidget {
  const MbxNewsScreen({super.key});
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                child: ButtonX(
                  title: '',
                  backgroundColor: ColorX.black.withValues(alpha: 0.4),
                  width: 40.0,
                  height: 40.0,
                  cornerRadius: 20.0,
              ...
              Positioned(
                left: 0.0,
                top: (MediaX.width * MbxNewsModel.imageAspectRatio) - 16.0,
                right: 0.0,
                bottom: 0.0,
                child: ContainerX(
